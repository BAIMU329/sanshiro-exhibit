  ...
  return (
    <SectionShell id="hero" index="01" className="min-h-[100svh]">
      <div ref={ref} className="section-veil relative flex min-h-[100svh] items-end py-20">
        ...
        />
        <div className="kanji-ghost ambient-drift absolute right-10 top-8 hidden text-[13rem] leading-none xl:block">
          東京
        </div>
        ...
        <motion.div
          style={{ y: plaqueY }}
          className="route-plaque absolute right-6 top-16 hidden w-64 rounded-[28px] p-5 xl:block"
        >
        ...
        <motion.div
          style={{ y: plaqueY }}
          className="route-plaque absolute bottom-24 right-24 hidden max-w-xs rounded-[26px] p-5 xl:block"
        >
